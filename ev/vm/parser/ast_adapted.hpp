...
BOOST_FUSION_ADAPT_STRUCT(ev::vm::ast::anonymous_function_declaration_t,
                          arguments,
                          return_type,
                          expression)
BOOST_FUSION_ADAPT_STRUCT(ev::vm::ast::function_declaration_t,
                          name,
                          arguments,
                          return_type,
                          expression)
BOOST_FUSION_ADAPT_STRUCT(ev::vm::ast::variable_declaration_t,
                          type_name,
                          variable_name)
